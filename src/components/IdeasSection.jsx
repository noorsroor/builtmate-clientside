...
const IdeasSection = () => {
  ...
  useEffect(() => {
    axios.get("https://builtmate-serverside.onrender.com/api/home-projects")
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-4 gap-10">
          ...
          <div className="col-span-4 md:col-span-1 flex flex-col gap-10">
            {/* Backyard with pool */}
            <div onClick={() => navigate(`/ideas/${projects[0]?._id}`)} className="cursor-pointer hover:shadow-lg    relative rounded-[24px] overflow-hidden aspect-square">
              <img 
            ...
            {/* Studio */}
            <div  onClick={() => navigate(`/ideas/${projects[4]?._id}`)} className="cursor-pointer hover:shadow-lg    relative rounded-[24px] md:h-96 overflow-hidden aspect-square">
              <img 
            ...
            {/* Living Room */}
            <div onClick={() => navigate(`/ideas/${projects[8]?._id}`)} className="cursor-pointer hover:shadow-lg    relative rounded-[24px] md:md:h-[200px] overflow-hidden aspect-square">
              <img 
          ...
          {/* Second column */}
          <div onClick={() => navigate(`/ideas/${projects[1]?._id}`)}  className="col-span-4 md:col-span-1 flex flex-col gap-10">
            {/* Home office */}
            ...
            {/* Bedroom */}
            <div onClick={() => navigate(`/ideas/${projects[5]?._id}`)} className="cursor-pointer hover:shadow-lg    relative rounded-[24px] md:h-[200px] overflow-hidden aspect-square">
              <img 
            ...
            {/* Bathroom */}
            <div onClick={() => navigate(`/ideas/${projects[9]?._id}`)} className="cursor-pointer hover:shadow-lg    relative rounded-[24px] overflow-hidden aspect-square">
              <img 
          ...
          {/* Third column */}
          <div onClick={() => navigate(`/ideas/${projects[2]?._id}`)} className="cursor-pointer hover:shadow-lg    col-span-4 md:col-span-1 flex flex-col gap-10">
            {/* Kitchen */}
            ...
            {/* Kidsroom */}
            <div onClick={() => navigate(`/ideas/${projects[6]?._id}`)} className="cursor-pointer hover:shadow-lg    relative rounded-[24px] overflow-hidden aspect-square">
              <img 
            ...
            {/* Home office 2 */}
            <div onClick={() => navigate(`/ideas/${projects[10]?._id}`)} className="cursor-pointer hover:shadow-lg    relative rounded-[24px] md:h-96 overflow-hidden aspect-square">
              <img 
          ...
          {/* Fourth column */}
          <div onClick={() => navigate(`/ideas/${projects[3]?._id}`)} className="cursor-pointer hover:shadow-lg    col-span-4 md:col-span-1 flex flex-col gap-10">
            {/* Bedroom */}
            ...
            {/* Bathroom */}
            <div onClick={() => navigate(`/ideas/${projects[7]?._id}`)} className="cursor-pointer hover:shadow-lg    relative rounded-[24px] overflow-hidden aspect-square md:h-96">
              <img 
            ...
            {/* Teenager playroom */}
            <div onClick={() => navigate(`/ideas/${projects[11]?._id}`)} className="cursor-pointer hover:shadow-lg     relative rounded-[24px] overflow-hidden aspect-square">
              <img 
