...
const [backgroundImagePreview, setBackgroundImagePreview] = useState(null);
  ...
  const handleOpenEmail = (service,email) => {
    let link = "";
    const subject = "Contact from Builtmate";
    const body = "Hello, I’d like to contact you regarding your services.";
    ...
    switch (service) {
      case "gmail":
        ...
        break;
      case "yahoo":
        link = `https://compose.mail.yahoo.com/?to=${email}&subj=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
        break;
      case "outlook":
  ...
  const handleQuoteSubmit = async (bookingId, price) => {
    toast.promise(
      ...
      }),
      {
        ...
        success: <b>Quote submitted successfully!</b>,
        error: <b>Failed to submit quote.</b>,
      }
    );
  };
    ...
    <div className="space-y-8">
                      ...
                      >
                        ...
                        <div className="bg-white m-2 rounded-xl p-6">
                          <div className="flex justify-between items-start mb-2">
                            <div>
                              <h3 className="text-xl font-bold">{booking.professional.userId.firstname+" "+ booking.professional.userId.lastname || "Pro name"}</h3>
                          ...
                          {booking.isPaid && (
                            ...
                            <button
                              onClick={() =>{ setShowOptions((prev) => !prev); setIsOpen(booking._id)}}
                              className="bg-black text-white px-6 py-3 rounded-md hover:bg-gray-800 transition"
                            >
                              Contact 
                            </button>

                            {showOptions && booking._id === isOpen && (
                              <div className="absolute z-10 bg-white border rounded-md shadow-md mt-2 w-48">
                                <button
                                  className="w-full text-left px-4 py-2 hover:bg-gray-100"
                                  onClick={() => handleOpenEmail("gmail",booking.professional.userId.email)}
                                >
                                  Gmail
                                </button>
                                <button
                                  className="w-full text-left px-4 py-2 hover:bg-gray-100"
                                  onClick={() => handleOpenEmail("yahoo",booking.professional.userId.email)}
                                >
                                  Yahoo Mail
                                </button>
                                <button
                                  className="w-full text-left px-4 py-2 hover:bg-gray-100"
                                  onClick={() => handleOpenEmail("outlook",booking.professional.userId.email)}
                                >
                                  Outlook
                                </button>
                                <button
                                  className="w-full text-left px-4 py-2 hover:bg-gray-100"
                                  onClick={() => handleOpenEmail("default",booking.professional.userId.email)}
                                >
                                  Default App
                                </button>
                              </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                          {bookings.map((booking) => (
                            ...
                            >
                              ...
                              {/* User and Type Info */}
                              <h3 className="text-base font-bold">{booking.user?.firstname +" "+ booking.user?.lastname || "User name"}</h3>
                              ...
                              {booking.status === "quoted" && (
                                <div className="mt-2 text-center text-blue-600 font-bold text-sm ">
                              ...
                              {booking.status === "paid" && (
                                ...
                                <div className="mt-2 text-center text-green-600 text-sm font-bold">
      ...
      {showOptions && booking._id === isOpen && (
        <div className="absolute z-10 bg-white border rounded-md shadow-md mt-2 w-48">
          <button
            className="w-full text-left px-4 py-2 hover:bg-gray-100"
            onClick={() => handleOpenEmail("gmail",booking.user.email)}
          >
            Gmail
          </button>
          <button
            className="w-full text-left px-4 py-2 hover:bg-gray-100"
            onClick={() => handleOpenEmail("yahoo",booking.user.email)}
          >
            Yahoo Mail
          </button>
          <button
            className="w-full text-left px-4 py-2 hover:bg-gray-100"
            onClick={() => handleOpenEmail("outlook",booking.user.email)}
          >
            Outlook
          </button>
          <button
            className="w-full text-left px-4 py-2 hover:bg-gray-100"
            onClick={() => handleOpenEmail("default",booking.user.email)}
          >
            Default App
          </button>
        </div>
