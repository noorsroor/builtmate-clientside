      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col">
            ...
            <div onClick={()=> navigate('/findPro')} className="h-[200px] cursor-pointer bg-gradient-to-r from-yellow-700 via-black to-yellow-600 rounded-lg p-2 mb-6 flex-grow">
          ...
          <div className="flex flex-col">
            ...
            <div onClick={()=> navigate('/findPro')} className=" cursor-pointer bg-gradient-to-r h-[200px] from-yellow-700 via-black to-yellow-600 rounded-lg p-2 mb-6 flex-grow">
          ...
          <div className="flex flex-col">
            ...
            <div  onClick={()=> navigate('/findPro')} className="cursor-pointer bg-gradient-to-r from-yellow-700 via-black to-yellow-600 rounded-lg p-2 h-[200px] mb-6 flex-grow">
